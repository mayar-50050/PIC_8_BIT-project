...
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t *_pin_config)
{
    ...
    if(_pin_config == ((void*)0) || ((_pin_config->pin) > (8 -1)) || ((_pin_config->port) > (5 -1)) )
    {
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t *_pin_config, direction_t *_direction_status)
{
    ...
    if( (_pin_config != ((void*)0)) && (_pin_config->pin < 8) && (_direction_status != ((void*)0)))
    {
        *_direction_status = ((*tris_reg[_pin_config->port] >> _pin_config->pin) & ((uint8) 1 ) );
    }
    else
    {
        Status = (Std_ReturnType)0x00;
...
# 88 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_config, logic_t _logic)
{
    Std_ReturnType Status = (Std_ReturnType)0x01;
    if(_pin_config != ((void*)0) && (_pin_config->direction == GPIO_DIRECTION_OUTBUT) && (_pin_config->pin < 8))
    {
        switch(_logic)
        {
...
{
    Std_ReturnType Status = (Std_ReturnType)0x01;
    if( (_pin_config != ((void*)0)) && (_pin_config->pin < 8) && (_logic != ((void*)0)))
    {
        *_logic = ((*port_reg[_pin_config->port] >> _pin_config->pin) & ((uint8) 1 ) );
    }
    else
    {
        Status = (Std_ReturnType)0x00;
...
{
    Std_ReturnType Status = (Std_ReturnType)0x01;
    if((_direction_status != ((void*)0)) && (_port < 5))
    {
...
# 254 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType gpio_port_write_logic(const port_index_t _port, uint8 _logic)
{
    Std_ReturnType Status = (Std_ReturnType)0x01;
    if((_port < 5) )
...
# 279 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType gpio_port_read_logic(const port_index_t _port, uint8 *_logic)
{
    Std_ReturnType Status = (Std_ReturnType)0x01;
    if((_port < 5) )
...
# 303 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType gpio_port_toggle_logic(const port_index_t _port)
{
    Std_ReturnType Status = (Std_ReturnType)0x01;
    if((_port < 5) )
