...
# 32 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/../MCAL_std_types.h"
...
# 1 "ECU_Layer/../Projects/project1_calc/calc.h" 1
# 14 "ECU_Layer/../Projects/project1_calc/calc.h"
typedef struct
{
    keypad_t keypad;
    lcd_8b_t lcd;
...
Std_ReturnType program_state = (Std_ReturnType)0x00;
# 130 "ECU_Layer/ECU_layer_init.c"
calculator_t calc_v1 = {
  .keypad.keypad_connection_type = 0,

  .keypad.keypad_rows[0].port = PORTA_INDEX,
  .keypad.keypad_rows[0].pin = GPIO_PIN0,
  ...
  .keypad.keypad_rows[1].pin = GPIO_PIN1,
  ...
  .keypad.keypad_rows[2].pin = GPIO_PIN2,
  ...
  .keypad.keypad_rows[3].pin = GPIO_PIN3,
  ...
  .keypad.keypad_columns[0].pin = GPIO_PIN0,
  ...
  .keypad.keypad_columns[1].pin = GPIO_PIN1,
  ...
  .keypad.keypad_columns[2].pin = GPIO_PIN2,
  ...
  .keypad.keypad_columns[3].pin = GPIO_PIN3,
