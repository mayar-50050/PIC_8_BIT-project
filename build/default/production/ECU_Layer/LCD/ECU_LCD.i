...
# 32 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../MCAL_std_types.h"
...
Std_ReturnType lcd_4bit_initialize(const lcd_4b_t* _lcd)
{
    ...
    if(_lcd != ((void*)0))
    {
        ...
        _delay((unsigned long)((2)*(4000000UL/4000.0)));
        ret = lcd_4bit_send_command(_lcd, 0x0C|0x08|0x08);
        _delay((unsigned long)((19)*(4000000UL/4000000.0)));
        ret = lcd_4bit_send_command(_lcd, 0x06);
        _delay((unsigned long)((39)*(4000000UL/4000000.0)));
        ret = lcd_4bit_send_command(_lcd, 0x20|0x28|0x24);
                                          ...
                                          const uint8 _data[], uint8 mem_pos)
{
    ...
    if((_lcd != ((void*)0)) && ((mem_pos > 0) && (mem_pos < 9)))
    {
        mem_pos--;
...
Std_ReturnType lcd_8bit_initialize(const lcd_8b_t* _lcd)
{
    ...
    if(_lcd != ((void*)0))
    {
        ...
        for(counter = 0; counter < 0x08U; counter++)
        {
            ret = gpio_pin_initialize(&(_lcd->lcd_pins[counter]));
        }

        _delay((unsigned long)((20)*(4000000UL/4000.0)));
        ret = lcd_8bit_send_command(_lcd, 0x30|0x28);
        _delay((unsigned long)((5)*(4000000UL/4000.0)));
        ret = lcd_8bit_send_command(_lcd, 0x30|0x28);
        _delay((unsigned long)((150)*(4000000UL/4000000.0)));
        ret = lcd_8bit_send_command(_lcd, 0x30|0x28);
        ...
        _delay((unsigned long)((2)*(4000000UL/4000.0)));
        ret = lcd_8bit_send_command(_lcd, 0x0C|0x08|0x09);
        _delay((unsigned long)((19)*(4000000UL/4000000.0)));
        ret = lcd_8bit_send_command(_lcd, 0x06);
        _delay((unsigned long)((39)*(4000000UL/4000000.0)));
        ret = lcd_8bit_send_command(_lcd, 0x30|0x28|0x20);
    }
    else
    {
        ret = (Std_ReturnType)0x00;
