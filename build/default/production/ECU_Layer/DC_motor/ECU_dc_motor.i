...
# 10 "ECU_Layer/DC_motor/../../MCAL_Layer/GPIO/../compiler.h"
...
# 10 "ECU_Layer/DC_motor/../../MCAL_Layer/GPIO/../compiler.h" 2
# 13 "ECU_Layer/DC_motor/../../MCAL_Layer/GPIO/../MCAL_std_types.h" 2
# 32 "ECU_Layer/DC_motor/../../MCAL_Layer/GPIO/../MCAL_std_types.h"
...
Std_ReturnType dc_motor_initialize ( dc_motor_t *_dc_motor)
{
    ...
    if(_dc_motor != ((void*)0))
    {
        _dc_motor->pins[0x00U].direction = GPIO_DIRECTION_OUTBUT;
        _dc_motor->pins[0x01U].direction = GPIO_DIRECTION_OUTBUT;
        _dc_motor->pins[0x00U].logic = GPIO_OUTPUT_LOW;
        _dc_motor->pins[0x01U].logic = GPIO_OUTPUT_LOW;

        ret = gpio_pin_initialize( &(_dc_motor->pins[0x00U]));
        ret = gpio_pin_initialize( &(_dc_motor->pins[0x01U]));

        if (_dc_motor->motor_state == 0x01U)
        {
...
# 65 "ECU_Layer/DC_motor/ECU_dc_motor.c"
Std_ReturnType dc_motor_move_right (const dc_motor_t *_dc_motor)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_dc_motor != ((void*)0))
    {
        ret = gpio_pin_write_logic(&(_dc_motor->pins[0x00U]),GPIO_OUTPUT_HIGH);
        ret = gpio_pin_write_logic(&(_dc_motor->pins[0x01U]),GPIO_OUTPUT_LOW);
...
Std_ReturnType dc_motor_move_left (const dc_motor_t *_dc_motor)
{
    ...
    if(_dc_motor != ((void*)0))
    {
        ret = gpio_pin_write_logic(&(_dc_motor->pins[0x00U]),GPIO_OUTPUT_LOW);
        ret = gpio_pin_write_logic(&(_dc_motor->pins[0x01U]),GPIO_OUTPUT_HIGH);
    }
    else
    {
        ret = (Std_ReturnType)0x00;
...
# 112 "ECU_Layer/DC_motor/ECU_dc_motor.c"
Std_ReturnType dc_motor_stop (const dc_motor_t *_dc_motor)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_dc_motor != ((void*)0))
...
# 135 "ECU_Layer/DC_motor/ECU_dc_motor.c"
Std_ReturnType dc_motor_break (const dc_motor_t *_dc_motor)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_dc_motor != ((void*)0))
